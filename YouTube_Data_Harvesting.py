...
with col1:
    ...
    if Get_data or st.session_state.get("Get_state",False):
        ...
        api_version = 'v3'
        api_key = 'AIzaSyA8jhOcDrd94xUO99C2t0W6AQ92IuBLU4g'
...
with col2:
    ...
    if Migrate or st.session_state_migrate_sql:
        ...
        engine = create_engine('mysql+mysqlconnector://root:S_zubairhussain_2@localhost:3306/youtube_database', echo=False)
...
if question_tosql:
    connect_for_question = mysql.connector.connect(host='localhost', user='root', password='S_zubairhussain_2', db='youtube_database')
